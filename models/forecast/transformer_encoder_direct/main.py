...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "常用命令示例:\n"
            "  python forecast/transformer_encoder_direct/main.py train\n"
            "  python forecast/transformer_encoder_direct/main.py test\n"
            "  python forecast/transformer_encoder_direct/main.py predict --input forecast/transformer_encoder_direct/output/predict_input.json\n"
            "  python forecast/transformer_encoder_direct/main.py train --config forecast/transformer_encoder_direct/configs/config.yaml\n"
            "  python forecast/transformer_encoder_direct/main.py predict --input data.csv --output forecast/transformer_encoder_direct/output/prediction.csv"
        ),
