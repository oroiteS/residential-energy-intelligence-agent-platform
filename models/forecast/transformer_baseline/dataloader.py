"""Transformer 残差 baseline 任务的数据集与 LightningDataModule。"""
...
except ImportError:  # 兼容 `python forecast/transformer_baseline/dataloader.py`
    import importlib
...
class TransformerForecastDataModule(L.LightningDataModule):
    """Transformer 残差 baseline 任务的数据组织入口。"""
