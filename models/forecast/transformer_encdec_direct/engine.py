"""Patch encoder-decoder direct Transformer 训练与评估公共逻辑。"""
...
if __package__ is None or __package__ == "":
    ...
    from model import PatchEncDecDirectTransformerForecaster
else:
    from .config import DataConfig, ModelConfig, TrainConfig
    from .dataset import (
        DEFAULT_NORMALIZATION_MODE,
...
def build_model(model_config: ModelConfig) -> PatchEncDecDirectTransformerForecaster:
